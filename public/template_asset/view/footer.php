<div class="footer">
	<div class="ck">
		...
		<ul>
			<li>
				<img src="public/images/site/footer/icon-commitment-1.png" alt="" class="img-ck">
				<span class="txt-ck">Sản phẩm, hàng hóa chính hãng đa dạng phong phú. </span>
			</li>
			<li>
				<img class="img-ck" src="public/images/site/footer/icon-commitment-2.png" alt="">
				<span class="txt-ck">Luôn luôn giá rẻ & khuyến mại không ngừng. </span>
			</li>
			<li>
				<img class="img-ck" src="public/images/site/footer/icon-commitment-3.png" alt="">
	...
	<div class="gtct">
		...
		<div class="conn">
			...
			<ul>
				<li><a href="" target="_blank"><img src="public/images/site/footer/facebook.png" alt=""></a></li>
				<li><a href="" target="_blank"><img src="public/images/site/footer/email.png" alt=""></a></li>
				<li><a href="" target="_blank"><img src="public/images/site/footer/twitter.png" alt=""></a></li>
				<li><a href="" target="_blank"><img src="public/images/site/footer/google-plus.png" alt=""></a></li>
				<li><a href="" target="_blank"><img src="public/images/site/footer/youtube.png" alt=""></a></li>
			</ul>
		</div>
	</div>
	<div class="td">
