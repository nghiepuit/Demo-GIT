                ...
                <div class="col-lg-12 col-12 col-sm-12">
                  <div class="single_blog_archive wow fadeInUp">
                    <div class="blogimg_container">
                      <a href="news/{{$n->id}}" class="blog_img spe">
                        <img alt="img" src="upload/news/{{$n->img}}">
                      </a>
                    </div>
                    <h2 class="blog_title"><a href="news/{{$n->id}}"> {{$n->title}}</a></h2>
                    <p class="blog_summary">{{$n->title}}</p>
                    <a class="blog_readmore" href="news/{{$n->id}}">CHI TIẾT</a>
                  </div>
                </div>
