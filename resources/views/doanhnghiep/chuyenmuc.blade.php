                ...
                <div class="col-lg-12 col-12 col-sm-12">
                  <div class="single_blog_archive wow fadeInUp">
                    <div class="blogimg_container">
                      <a href="doanhnghiep/{{$cate1->cate_namekd}}/{{$sc->subcate_namekd}}" class="blog_img">
                        <img alt="img" src="upload/subcate/{{$sc->subcate_img}}">
                      </a>
                    </div>
                    <h2 class="blog_title"><a href="doanhnghiep/{{$cate1->cate_namekd}}/{{$sc->subcate_namekd}}"> {{$sc->subcate_name}}</a></h2>
